<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Report2.aspx.cs" Inherits="SSIS.Store.Report2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" 
        ...
        Height="720px" 
        DocumentMapWidth = "25%">
        <LocalReport ReportPath="CategoryQtyDeptReport.rdlc">
            <DataSources>
